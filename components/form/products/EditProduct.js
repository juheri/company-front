...
const Index = (props) => {
    ...
    useEffect(() => {
        const result_tags = props.productDetail.tags.map((tag) => {
            return tag.tag
        });
        setTags(result_tags)
    }, [props.productDetail.tags]);
        ...
        <React.Fragment>
            <Modal.Header closeButton>
                <Modal.Title id="contained-modal-title-vcenter">
                    <FaArrowLeft onClick={() => props.typeModal("detail")}/> Edit Produk
                </Modal.Title>
            </Modal.Header>
            <Modal.Body>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control
                        ...
                        value={props.productDetail.description}
                    />
                </Form.Group>
                <Form.Group className="mb-3">
