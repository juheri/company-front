...
const Index = () => {
  ...
  const onDelete = async (product_id) => {
    ...
    try {
      await deleteProduct(product_id, data.token).then(() => {
          ...
          <Container className="bg-light">
            {errorLoad && (
              <Alert variant="danger">
                Gagal memuat Data, silakan refresh kembali
              </Alert>
            )}
            <Row
              className="sticky-top bg-light align-items-center"
              ...
              {type == "detail" ? (
                <>
                  ...
                  <Modal.Body>
                    ...
                    <p>Tag: </p>
                    {productDetail &&
                      productDetail.tags.map((data_tag, x) => {
                        return (
                          <a href="#" key={x}>
                            {" "}
                            {data_tag.tag}{" "}
                  ...
                  <Modal.Footer>
                    <Button
                      variant="danger"
                      onClick={() => onDelete(productDetail.id)}
                    >
                      {loadingDelete ? (
                        <Spinner
                          as="span"
